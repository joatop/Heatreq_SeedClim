...
#### regressions ####
mod.diff_TT2_alpine <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
                                    data = diff.cumsum[diff.cumsum$TTtreat=='TT2' & 
                                                         diff.cumsum$alt.orig=='alpine',])

mod.diff_TTC_alpine <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
                                    data = diff.cumsum[diff.cumsum$TTtreat=='TTC' & 
                                                         diff.cumsum$alt.orig=='alpine',])

mod.diff_TT2_alpine.sp.alp <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
                                    data = diff.cumsum.sp.alp[diff.cumsum.sp.alp$TTtreat=='TT2' & 
                                                                diff.cumsum.sp.alp$alt.orig=='alpine',])

mod.diff_TT2_subalpine <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
                                    data = diff.cumsum[diff.cumsum$TTtreat=='TT2' & 
                                                         diff.cumsum$alt.orig=='sub-alpine',])

mod.diff_TTC_subalpine <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
                                    data = diff.cumsum[diff.cumsum$TTtreat=='TTC' & 
                                                         diff.cumsum$alt.orig=='sub-alpine',])

mod.diff_TT2_subalpine.sp.subalp <- glmmTMB(diff.cumsum2~0+Hrf+(1|siteID), family='beta_family',
